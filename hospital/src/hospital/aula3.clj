...
;; Aqui é considerado um vetor valido de nil
(pprint (s/validate Numeros nil))

;; nil não é s/Num
;; (pprint (s/validate s/Num nil))
;; Mas pode ser uma sequência de tamanho nil então nil é um [s/Num]
;; (pprint (s/validate [s/Num] nil))
...
;; plano é ma keyword obrigatória no mapa, mas ela pode ter um valor vazio (nil)
